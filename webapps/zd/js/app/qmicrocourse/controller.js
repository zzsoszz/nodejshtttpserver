    ...
    $scope.tableoption=
     {
       ...
       pageSize:10,
       cols:[
         {title:'关键词',name:"word",type:"text",addEnable:true,searchEnable:true,updateEnable:true,detailEnable:true,listEnable:false},
         {title:'编号',name:"id",type:"text",addEnable:false,searchEnable:false,updateEnable:false,detailEnable:false,listEnable:false},
         {title:'名称',name:"mainTitle",type:"text",addEnable:true,searchEnable:true,updateEnable:true,detailEnable:true,listEnable:true},
         {title:'内容',name:"content",type:"text",addEnable:true,searchEnable:true,updateEnable:true,detailEnable:true,listEnable:true},
         {title:'封面',name:"courseCover",type:"text",addEnable:true,searchEnable:true,updateEnable:true,detailEnable:true,listEnable:true},
         {title:'课程类型',name:"province",type:"muliplyselect",typedata:schoolprovinces,addEnable:true,searchEnable:true,updateEnable:true,detailEnable:true,listEnable:true},
       ]
     };
