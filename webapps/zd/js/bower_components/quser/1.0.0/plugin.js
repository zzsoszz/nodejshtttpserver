var quser=angular.module('quser',["Ajax"])
quser.service("quserService",function($http,$ajax){
 return {
...
quser.component('selectQuser', {
	  ...
	  templateUrl:baseUrl+'js/bower_components/quser/1.0.0/select-quser.html',
